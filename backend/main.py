...
# TODO: Comment out again for production
# DATABASE_URL = os.getenv("DATABASE_URL")
# TODO: set up local sqlite db, because http protocol is not supported by SQLAlchemy
engine = create_engine("http://localhost:3000")
